...
## 📄 FILE 4: `03-ADVANCED.md` (Advanced Topics — Stack-Agnostic)

```markdown
# ADVANCED.md — Advanced Topics (Stack-Agnostic)

> **Untuk:** Proyek enterprise yang butuh error handling, observability, dan scaling strategy.  
> **Prinsip:** Gunakan hanya jika benar-benar dibutuhkan — jangan over-engineering.
